...
export const FeatureSection = ({ topIcon, topTitle, title, content, linkHref, linkLabel, align = 'left' }: Props) => (
  <section className="grid-cols-5 gap-4 py-32 text-tic-blue md:grid">
